...
<body>
    ...
    <div class="buscar-box">
        ...
        <div class="botones-filtro">
            <a href="../../Controlador/LogicaVenta.php?consultar-venta=2"><button type="button" class="btn btn-success"><i class="fa-solid fa-receipt"></i> Ver Activos</button></a>
            <a href="../../Controlador/LogicaVenta.php?inactivos=2"><button type="button" class="btn btn-secondary"><i class="fa-solid fa-ban"></i> Ver Inactivos</button></a>
            <a href="../../Controlador/LogicaVenta.php?reporte=1"><button type="button" class="btn btn-success"><i class="fa-solid fa-file-excel"></i> Crear Excel</button></a>
        </div>
    </div>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <!-- Botón Restaurar -->
                        <a href="../../Controlador/LogicaVenta.php?restaurar=2&id=<?php echo $valor['IdVenta']; ?>" 
                        onclick="return confirm('¿Desea restaurar esta venta?')">
                        ...
                        <?php else: ?>
                        <!-- Botón Eliminar -->
                        <a href="../../Controlador/LogicaVenta.php?eliminar-venta=4&id=<?php echo $valor['IdVenta']; ?>" 
                        onclick="return confirm('¿Seguro que desea eliminar esta venta?')">
                            <button class="btn-accion btn-eliminar">
