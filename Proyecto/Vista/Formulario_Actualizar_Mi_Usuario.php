...
if(!isset($_SESSION['mi_usuario_fulldata']) || empty($_SESSION['mi_usuario_fulldata'])) {
    echo "<script>
...
$datos = $_SESSION['mi_usuario_fulldata'];
...
<body>
    ...
    <section>
        ...
        <form method="POST" action="../Controlador/LogicaUsuario.php" enctype="multipart/form-data">
            <input type="hidden" name="actualizar-mi-usuario" value="3">
